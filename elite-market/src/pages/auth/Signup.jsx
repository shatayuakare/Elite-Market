                    ...
                    <form className="w-full" onSubmit={signUpHandler}>
                        <div className="grid md:grid-cols-2 md:gap-6">
                            ...
                            <div className="relative z-0 w-full mb-5 group">
                                <input type="text" name="first_name" id="first_name" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none outline-none focus:border-blue-600 peer" placeholder=" " required autoFocus
                                    value={fname}
                            ...
                            <div className="relative z-0 w-full mb-5 group">
                                <input type="text" name="last_name" id="last_name"
                                    className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none outline-none focus:border-blue-600 peer" placeholder=" " required
                                    value={lname}
                        ...
                        <div className="grid md:grid-cols-2 md:gap-6">
                            ...
                            <div className="relative z-0 w-full mb-5 group">
                                <label for="underline_select" className="sr-only">Account Role</label>
                                <select id="underline_select" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none outline-none focus:border-blue-600 peer" defaultValue={'buyer'}>
                        ...
                        <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-sm text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            {
                                loading ?
                                    <span>loading</span>
                                    :
